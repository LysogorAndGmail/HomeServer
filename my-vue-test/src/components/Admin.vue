...
const cabinColor = ref('#f5ce0a'); // Браузерный инпут цвета отлично работает с HEX
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="form-check form-switch ms-3 me-3">
          <input
              v-model="isOzvuchkaEnabled"
              class="form-check-input"
              type="checkbox"
              id="flexSwitchCheckDefault"
          >
          <label class="form-check-label" for="flexSwitchCheckDefault">Ozvuchka</label>
        </div>
